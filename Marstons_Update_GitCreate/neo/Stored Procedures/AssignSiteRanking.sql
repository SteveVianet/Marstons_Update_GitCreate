CREATE PROCEDURE [neo].[AssignSiteRanking]
(
	@EDISID		INT,
	@RankingTypeID	INT,
...
WHERE EDISID = @EDISID AND RankingCategoryID = @CategoryID AND ValidTo =@ValidTo
...
GO
GRANT EXECUTE
    ON OBJECT::[neo].[AssignSiteRanking] TO PUBLIC
    AS [dbo];
