CREATE PROCEDURE [dbo].[AddVisitDamages]
(
	@VisitID			INT,
	@DamagesType		INT,
...
INSERT INTO dbo.VisitDamages
(VisitRecordID, DamagesType, Product, ReportedDraughtVolume, CalCheck, DraughtVolume, Cases, Bottles, Damages, Agreed, DraughtStock, Comment)

VALUES
(@VisitID, @DamagesType, @Product, @ReportedDraughtVolume, @CalCheck, @DraughtVolume, @Cases, @Bottles, @Damages, @Agreed, @DraughtStock, @Comment)

SET @NewID = @@IDENTITY

GO
GRANT EXECUTE
    ON OBJECT::[dbo].[AddVisitDamages] TO PUBLIC
    AS [dbo];
