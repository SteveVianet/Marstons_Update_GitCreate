CREATE PROCEDURE [dbo].[GetSiteDispenseQuality]
(
	@EDISID			INT,
	@From				DATETIME,
	@To				DATETIME,
...
SELECT  Actions.EDISID,
	...
	ISNULL(SiteProductSpecifications.FlowSpec, Products.FlowRateSpecification),
	ISNULL(SiteProductSpecifications.FlowTolerance, Products.FlowRateTolerance)
FROM (SELECT * FROM DispenseActions WHERE EDISID = @EDISID AND (TradingDay BETWEEN @From AND @To) AND (LiquidType = 2) AND (Pints >= 0.3)) AS Actions
...
SELECT  Actions.EDISID,
	...
	ISNULL(SiteProductSpecifications.FlowSpec, Products.FlowRateSpecification),
	ISNULL(SiteProductSpecifications.FlowTolerance, Products.FlowRateTolerance)
FROM (SELECT * FROM DispenseActions WHERE EDISID = @EDISID2 AND (TradingDay BETWEEN @From AND @To) AND (LiquidType = 2) AND (Pints >= 0.3)) AS Actions
JOIN Products ON Products.[ID] = Actions.Product
JOIN @SitePumpOffsets AS SitePumpOffsets ON SitePumpOffsets.EDISID = Actions.EDISID
JOIN @AllSitePumps AS AllSitePumps ON AllSitePumps.PumpID = Actions.Pump + PumpOffset
				     AND AllSitePumps.ProductID = Actions.Product
...
SELECT  Actions.EDISID,
	...
	ISNULL(SiteProductSpecifications.FlowSpec, Products.FlowRateSpecification),
	ISNULL(SiteProductSpecifications.FlowTolerance, Products.FlowRateTolerance)
FROM (SELECT * FROM DispenseActions WHERE EDISID = @EDISID3 AND (TradingDay BETWEEN @From AND @To) AND (LiquidType = 2) AND (Pints >= 0.3)) AS Actions
JOIN Products ON Products.[ID] = Actions.Product
JOIN @SitePumpOffsets AS SitePumpOffsets ON SitePumpOffsets.EDISID = Actions.EDISID
JOIN @AllSitePumps AS AllSitePumps ON AllSitePumps.PumpID = Actions.Pump + PumpOffset
				     AND AllSitePumps.ProductID = Actions.Product
...
SELECT  Actions.EDISID,
	...
	ISNULL(SiteProductSpecifications.FlowSpec, Products.FlowRateSpecification),
	ISNULL(SiteProductSpecifications.FlowTolerance, Products.FlowRateTolerance)
FROM (SELECT * FROM DispenseActions WHERE EDISID = @EDISID4 AND (TradingDay BETWEEN @From AND @To) AND (LiquidType = 2) AND (Pints >= 0.3)) AS Actions
JOIN Products ON Products.[ID] = Actions.Product
JOIN @SitePumpOffsets AS SitePumpOffsets ON SitePumpOffsets.EDISID = Actions.EDISID
JOIN @AllSitePumps AS AllSitePumps ON AllSitePumps.PumpID = Actions.Pump + PumpOffset
				     AND AllSitePumps.ProductID = Actions.Product
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetSiteDispenseQuality] TO PUBLIC
    AS [dbo];
