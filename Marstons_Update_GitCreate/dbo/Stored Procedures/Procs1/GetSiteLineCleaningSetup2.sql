CREATE PROCEDURE [dbo].[GetSiteLineCleaningSetup2]
(
	@EDISID	INT,
	@From		DATETIME,
	@To		DATETIME,
...
BEGIN
	...
	JOIN DispenseActions ON MasterDates.EDISID = DispenseActions.EDISID
		AND MasterDates.Date = DispenseActions.TradingDay
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetSiteLineCleaningSetup2] TO PUBLIC
    AS [dbo];
