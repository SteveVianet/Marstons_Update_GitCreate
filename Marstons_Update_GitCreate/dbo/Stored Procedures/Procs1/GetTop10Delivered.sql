CREATE PROCEDURE GetTop10Delivered
	@EDISID INT = NULL,
	@UserID INT = NULL,
	@From DATE,
	@To DATE,
...
BEGIN
	...
	SELECT TOP 10 d.Product, p.Description, SUM(d.Quantity) * 8 AS Quantity -- Delivered Quantity stored as Gallons - Converting to Pints
	FROM @Sites AS s
	...
	GROUP BY d.Product, p.Description
	ORDER BY Quantity DESC
    
END
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetTop10Delivered] TO PUBLIC
    AS [dbo];
