--/*
CREATE PROCEDURE [dbo].[GetWebUserSiteSummaryForCustomer]
(
	@UserID			INT,
	@From			DATETIME,
	@To				DATETIME
...
/* Based on: GetWebUserSiteSummary
    Modified to restrict the TL/Ranking displayed to the customer.
*/

/* Debug Parameters */
--DECLARE @UserID			INT = 21504
--DECLARE	@From			DATETIME = '2017-01-02'
--DECLARE	@To				DATETIME = '2017-03-26'
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[GetWebUserSiteSummaryForCustomer] TO PUBLIC
    AS [dbo];
