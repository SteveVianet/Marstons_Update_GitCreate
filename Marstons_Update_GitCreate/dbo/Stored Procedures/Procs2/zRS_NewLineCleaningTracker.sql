...
CREATE PROCEDURE [dbo].[zRS_NewLineCleaningTracker] (
    @From   DATETIME = NULL,
    @To     DATETIME = NULL
    )
AS
...
--DECLARE @From   DATETIME = '2014-11-01'
--DECLARE @To     DATETIME = '2014-12-01'
...
JOIN PubcoCalendars ON PeriodCacheCleaningDispense.[Date] BETWEEN PubcoCalendars.FromWC
        AND PubcoCalendars.ToWC
JOIN (
    SELECT 
        Sites.EDISID,
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[zRS_NewLineCleaningTracker] TO PUBLIC
    AS [dbo];
