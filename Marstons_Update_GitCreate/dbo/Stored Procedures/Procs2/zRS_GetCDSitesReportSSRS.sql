CREATE PROCEDURE [dbo].[zRS_GetCDSitesReportSSRS]
...
--ORDER BY RMName, BDMName, SiteID, PeriodYear, PeriodNumber (Prior to change to ordering)
ORDER BY TYPeriod
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[zRS_GetCDSitesReportSSRS] TO PUBLIC
    AS [dbo];
