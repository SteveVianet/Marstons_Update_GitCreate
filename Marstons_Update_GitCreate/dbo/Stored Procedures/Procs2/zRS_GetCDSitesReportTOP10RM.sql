CREATE PROCEDURE [dbo].[zRS_GetCDSitesReportTOP10RM]
...
SELECT 		 Sites.RMName
			  ...
			  ,RANK() OVER (Partition BY RMName ORDER BY Reds.CDTY) AS [Rank]
...
GO
GRANT EXECUTE
    ON OBJECT::[dbo].[zRS_GetCDSitesReportTOP10RM] TO PUBLIC
    AS [dbo];
